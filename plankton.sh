...
echo -e  "*__*__*__*__*__*__*__*__*__*__*__*__*__*__*__*__*__*__*__*__*"
...
echo -e "<<>><<>><<>><<>><<>><<>><<>><<>>" | lolcat
echo -e $c ">6. hackbox${endc}";
echo -e "<<>><<>><<>><<>><<>><<>><<>><<>>" | lolcat
echo -e $r ">7. Exit${endc}";
echo ""
echo -e "╭─b0nd0l" |lolcat
read -p "╰─@" pil;
...
6) git clone https://github.com/samhaxr/hackbox
echo -e "${y} Installer hackbox..."
echo -e "${y} cd hackbox"
echo -e "${y} python2 hackbox.py"
cd /data/data/com.termux/files/home/hackbox
python2 /data/data/com.termux/files/home/hackbox/ hackbox.py

;;

7) echo "balik lagi ah ga jadi deh :v" | lolcat
exit
;;
